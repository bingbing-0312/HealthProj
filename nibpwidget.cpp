...
NIBPWidget::NIBPWidget(QWidget *parent) : QWidget(parent)
{
    ...
    playoutmiddle->addWidget(pCurrentTimeLabel,0,Qt::AlignTop|Qt::AlignRight);
    playoutmiddle->addWidget(middlemiddle,1,Qt::AlignTop|Qt::AlignLeft);
    ...
    playoutRight->addWidget(rightmiddle,0,Qt::AlignCenter);
    playoutRight->addWidget(rightbottom);
    bodyright->setLayout(playoutRight);
    playoutWhole->addWidget(wholehead,0,Qt::AlignTop);
    playoutWhole->addWidget(wholebody,1,Qt::AlignTop);
    ...
    title->setStyleSheet("color: rgb(7, 135, 255); font: 11pt , Adobe 黑体 Std R;");
    pCurrentTimeLabel->setStyleSheet("color: rgb(7, 135, 255);font: 10pt Adobe 黑体 Std R;");
    ...
    rightmiddle->setStyleSheet("color: rgb(7, 135, 255); font: 17pt , Adobe 黑体 Std R");
